  ...
  return (
    <div className="lg:col-span-1 lg:max-w-[380px] max-w-[500px]">
      <div className="bg-white border border-gray-100 shadow-sm rounded-lg p-6 sticky top-8">
        <h2 className="text-[14px] font-regular text-orange-500 mb-6">
          Summary
        </h2>

        <div className="space-y-4">
          <div>
            <label className="block text-b2 font-regular text-gray-700 mb-4">
              Subscription
            </label>
          ...
          <div className="pt-4 space-y-4">
            ...
            <div className="flex justify-between">
              <span className="text-black text-b2 font-regular">
                Payment method
              </span>
              <span className="text-gray-700 text-b2 font-regular">
                {paymentMethod === "card"
          ...
          <button
            ...
            className="w-full btn-blue-500 text-white py-4 px-4 rounded-lg hover:bg-blue-600 transition disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer mt-6"
          >
